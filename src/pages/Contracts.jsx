            ...
            <div className="flex-1 overflow-auto w-full">
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm flex items-center justify-center min-h-[400px]">
                    <div className="text-center p-8">
                        ...
                        <h3 className="text-lg font-medium text-gray-900 mb-1">Contracts System</h3>
                        <p className="text-gray-500 text-sm max-w-sm mx-auto">The digital signature implementation and contract management dashboard is being built here.</p>
                    </div>
                </div>
            </div>
        </div>
